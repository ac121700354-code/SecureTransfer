...
contract FeeCollector is Ownable, ReentrancyGuard {
    ...
    // 质押/社区激励地址 (Removed: managed via DAO treasury)
    ...
    // uint256 public stakingRatioBps = 3000;   // 30% 质押/激励 (Removed)
    ...
    function setRatios(uint256 _burnRatio) external onlyOwner {
        require(_burnRatio <= 10000, "Ratios too high");
        burnRatioBps = _burnRatio;
        // stakingRatioBps removed
