...
async function main() {
    console.log("Starting Mock BFR Price Setup...");
    ...
    // 1. 设置 Mock 价格 ($100)
    console.log("\n1. Setting Mock Price for BFR to $100...");
    ...
    console.log("\nSetup Completed! BFR is now priced at $100.");
    console.log("You can now test BFR transfers on the frontend.");
}
